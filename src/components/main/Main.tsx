        ...
        <>
            ...
            <div className={style.wrapper}>
                <div className={style.block}>
                    ...
                    <a href={"https://ping.pub/ixo/staking/ixovaloper1680a2sy8z63cxczjl34xpzusv4es7yrn6y4f5x"} className={style.link}>Explorer</a>
                ...
                <div className={style.block}>
                    ...
                    <a href={"https://www.mintscan.io/gravity-bridge/validators/gravityvaloper18u9pws4989n7fmx5pduev7starj8wqgg4jcxr3"} className={style.link}>Explorer</a>
                    <div title="Copy address to clipboard">
                ...
                <div className={style.block}>
                    ...
                    <a href={"https://www.mintscan.io/rizon/validators/rizonvaloper1gke47wnpdnqqspju5xe5448gxmz36vt8fksjmc"} className={style.link}>Explorer</a>
                    <div title="Copy address to clipboard">
                ...
                <div className={style.block}>
                    ...
                    <a href={"https://www.mintscan.io/ki-chain/validators/kivaloper1mfr64h8rmnlg2g90m6qk3zw80vgxmuumq0ng9x"} className={style.link}>Explorer</a>
                    <div title="Copy address to clipboard">
                ...
                <div className={style.block}>
                    ...
                    <a href={"https://www.mintscan.io/bitsong/validators/bitsongvaloper13g02l4y2es8ppls7ar5zh58ldre8q7tsv6kqer"} className={style.link}>Explorer</a>
                    <div title="Copy address to clipboard">
                ...
                <div className={style.block}>
                    ...
                    <a href={"https://www.mintscan.io/chihuahua/validators/chihuahuavaloper1nh26fjk060g4umun5czgdkprws4qmzaxmeqmlc"} className={style.link}>Explorer</a>
                    <div title="Copy address to clipboard">
                ...
                <div className={style.block}>
                    ...
                    <a href={"https://explorer.assetmantle.one/validators/mantlevaloper1ppvfpcp7grhgpkvse4rk877ysuztg73r04y68z"} className={style.link}>Explorer</a>
                    <div title="Copy address to clipboard">
                ...
                <div className={style.block}>
                    ...
                    <a href={"https://app.nomic.io/"} className={style.link}>Explorer</a>
                    <div title="Copy address to clipboard">
                ...
                <div className={style.block}>
                    ...
                    <a href={"https://explorer.postcapitalist.io/galaxy/staking/galaxyvaloper1qeln3m90f3p0erclyyczspeeeujslcxy3kqe3k"} className={style.link}>Explorer</a>
                    <div title="Copy address to clipboard">
                        <span className={style.hash}>galaxyvaloper1qeln3m90f3p0erclyyczspeeeujslcxy3kqe3k</span>
                        <CopyIcon value={"galaxyvaloper1qeln3m90f3p0erclyyczspeeeujslcxy3kqe3k"}/>
                    </div>
